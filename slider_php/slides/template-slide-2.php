<?php 
/* 
    Template Name: Template slide 2
...
<div class="swiper-slide container-fluid" style="background-image: url(<?= get_field('background'); ?>);">
	<div class="wrap-img wrap-img-med mx-auto">
		<img src="<?= get_field('image'); ?>" alt="">
	</div>
	<div class="row">
		<div class="row banner container">
			<div class="wrap-img mx-auto">
		...
		<div class="row container">
			<a href="#<?= get_field('link_button'); ?>" class="link-button mx-auto"><button><?= get_field('button'); ?></button></a>
		</div>
	</div>
</div>
